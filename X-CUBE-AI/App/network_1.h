...
#define AI_NETWORK_1_ORIGIN_MODEL_NAME   "movement_predictor_static_4"
...
#define AI_NETWORK_1_IN_1_HEIGHT      (30)
#define AI_NETWORK_1_IN_1_CHANNEL     (1)
#define AI_NETWORK_1_IN_1_SIZE        (30)
#define AI_NETWORK_1_IN_1_SIZE_BYTES  (120)
...
#define AI_NETWORK_1_OUT_1_CHANNEL     (4)
#define AI_NETWORK_1_OUT_1_SIZE        (4)
#define AI_NETWORK_1_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_NETWORK_1_N_NODES (4)
