...
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZES \
  { 17664, }
#define AI_NETWORK_1_DATA_ACTIVATIONS_SIZE     (17664)
#define AI_NETWORK_1_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_1_DATA_ACTIVATION_1_SIZE    (17664)



#define AI_NETWORK_1_DATA_WEIGHTS_SIZES \
  { 202004, }
#define AI_NETWORK_1_DATA_WEIGHTS_SIZE         (202004)
#define AI_NETWORK_1_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_1_DATA_WEIGHT_1_SIZE        (202004)
